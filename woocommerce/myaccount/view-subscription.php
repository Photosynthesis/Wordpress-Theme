...
<table class="table table-sm table-striped shop_table subscription_details">
  <tr>
...
<table class="table table-sm table-striped shop_table order_details">
  <thead>
    <tr>
        ...
        if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
          ...
          <tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $subscription ) ); ?>">
            ...
            <td class="product-name">
              ...
              echo wp_kses_post( apply_filters( 'woocommerce_order_item_quantity_html', ' <em class="small product-quantity">' . sprintf( '&times; %s', $item['qty'] ) . '</em>', $item ) );
