...
<div class="woocommerce_account_subscriptions">
  ...
  <table class="table table-sm table-striped table-bordered shop_table shop_table_responsive my_account_subscriptions my_account_orders">
  ...
  <?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
    <tr class="order">
      ...
      <td class="subscription-actions order-actions">
        <a href="<?php echo esc_url( $subscription->get_view_order_url() ) ?>" class="btn btn-sm btn-secondary btn-block button view"><?php echo esc_html_x( 'View', 'view a subscription', 'woocommerce-subscriptions' ); ?></a>
