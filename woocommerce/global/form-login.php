...
<form class="woocomerce-form woocommerce-form-login login" method="post" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
  ...
  <div class='row'>
    <div class="form-group col-12">
      <label for="username"><?php _e( 'Username or email', 'woocommerce' ); ?> <span class="text-danger required">*</span></label>
      <input type="text" class="form-control input-text" name="username" id="username" />
    </div>
    <div class="form-group col-12">
      <label for="password"><?php _e( 'Password', 'woocommerce' ); ?> <span class="text-danger required">*</span></label>
  ...
  <div class='form-group'>
    <input type="submit" class="mr-2 btn btn-primary button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
    <input type="hidden" name="redirect" value="<?php echo esc_url( $redirect ) ?>" />
    <div class='form-check d-inline'>
      <label class="form-check-label woocommerce-form__label woocommerce-form__label-for-checkbox inline">
        <input class="form-check-input woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php _e( 'Remember me', 'woocommerce' ); ?></span>
      </label>
    </div>
  </div>
