...
class ThemeUtilities
{
   ...
   */
  public static function cache_result($function_to_cache, $cache_key, $timeout) {
...
add_shortcode('escape_ampersands', array('ThemeUtilities', 'escape_ampersands'));
add_shortcode('formidable_to_rss_date', array('ThemeUtilities', 'formidable_to_rss_date'));
