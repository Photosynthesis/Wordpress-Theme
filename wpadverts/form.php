...
<form action="" method="post">
    <fieldset class='w-100'>
        ...
        <div class="form-group <?php echo esc_attr( str_replace("_", "-", $field["type"] ) . " adverts-field-name-" . $field["name"] ) ?> <?php if(adverts_field_has_errors($field)): ?>adverts-field-error has-danger<?php endif; ?>">
